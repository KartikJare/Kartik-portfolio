...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState([
        {
            role: "bot",
            text: "Hi, I am Kartik's AI portfolio assistant. Ask me about skills, projects, or contact details.",
        },
    ]);
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            setMessages((prev) => [
                ...
                {
                    role: "bot",
                    text: "Chatbot server is not connected. Please start backend server.",
                },
            ]);
        } finally {
            setLoading(false);
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9999]">
            ...
            rounded-3xl shadow-[0_0_40px_rgba(34,211,238,0.18)] overflow-hidden flex flex-col"
                >
                    <div
                        className="bg-[#07101f] border-b border-cyan-400/20 text-cyan-300 p-4 flex justify-between items-center"
                    >
                        <div>
                            <h2
                                className="font-bold text-lg tracking-wide text-cyan-300"
                            >
                                Kartik AI Assistant
                            </h2>
                    ...
                    >
                        ...
                        {loading && (
                            <div className="flex justify-start">
                                <div
                                    className="bg-[#111827] text-cyan-100 px-4 py-2 rounded-2xl text-sm border border-cyan-400/10"
                                >
                                    Thinking...
                                </div>
                            </div>
                    ...
                    <div
                        className="p-3 border-t border-cyan-400/10 bg-[#07101f]"
                    >
