import { FaJava, FaReact, FaPython, FaJs, FaCuttlefish, FaWindows } from "react-icons/fa";
import { SiCplusplus, SiSharp, SiTailwindcss, SiNextdotjs, SiMongodb, SiExpress, SiSpringboot, SiMysql } from "react-icons/si";
...
export default function Skills() {
    ...
    return (
        <section id="skills"
            ref={sectionRef}
            className="h-1/2 w-full p-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
            ...
            <motion.h2 className="text-4xl mt-5 sm:text-5xl font bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] z-10"
